...
const words=["a", "about", "after", "again", "all", "always", "am", "an", "and", "angry", "another", "any", "are", "around", "as", "at", "away", "awful", "back", "bad", "be", "beautiful", "because", "been", "before", "best", "better", "big", "but", "by", "can", "cat", "certainly", "completely", "could", "crazy", "cute", "dad", "day", "definitely", "did", "different", "dog", "don’t", "down", "dragon", "drink", "easily", "else", "even", "every", "extremely", "fast", "find", "first", "for", "from", "funny", "get", "girl", "give", "go", "good", "got", "grandma", "great", "had", "has", "have", "he", "haunted", "her", "here", "him", "his", "how", "I", "if", "illegal", "in", "inside", "is", "it", "just", "kind", "know", "large", "last", "late", "little", "look", "lost", "love", "make", "massive", "maybe", "me", "might", "more", "most", "my", "never", "new", "next", "nice", "no", "not", "now", "of", "off", "old", "on", "once", "one", "only", "or", "other", "our", "out", "outside", "over", "perfect", "probably", "really", "red", "right", "said", "same", "secretly", "she", "should", "silly", "small", "so", "some", "someone", "something", "sorry", "stolen", "strange", "suspicious", "terrible", "than", "that", "the", "their", "them", "then", "there", "these", "they", "thing", "this", "those", "three", "tiny", "to", "today", "together", "too", "totally", "under", "until", "up", "very", "was", "we", "weird", "were", "what", "when", "where", "which", "who", "why", "will", "with", "without", "woman", "work", "would", "wrong", "wow", "yes", "you", "your", "yesterday", "accidentally", "actually", "almost", "apparently", "awkward", "boss", "broke", "danced", "escaped", "exploded", "famous", "friend", "ghost", "grandpa", "handsome", "hungry", "juice", "kitchen", "killed", "monster", "neighbour", "pizza", "police", "restaurant", "screamed", "sandwich", "secret", "stuck", "surprise", "wizard", "zombie", "however", "please", "thank", "thanks", "hello", "goodbye", "help", "stop", "run", "hide", "quick", "quiet", "loud", "absolutely"];
const rooms=new Map();
const makeCode=()=>{let c;do c=Math.random().toString(36).slice(2,6).toUpperCase();while(rooms.has(c));return c};
const makeTiles=()=>[...words].sort(()=>Math.random()-.5).slice(0,100);
